...
$_['text_i_am_returning_customer'] = 'Вход в систему';
...
$_['error_attempts']               = 'Вы превысили максимальное количество попыток авторизации. Обратитесь к администратору системы';
$_['error_approved']               = 'Необходимо подтвердить аккаунт перед авторизацией.';
$_['error_user_not_in_structure']  = 'Пользователь не найден в Структуре. Обратитесь к администратору';
