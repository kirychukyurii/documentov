...
class ModelSettingExtension extends Model
{
  ...
  {
    // print_r($this->daemon->exec("GetAvailableMods", $type));
    // exit;
    return $this->daemon->exec("GetAvailableMods", $type);
  ...
  /**
   * Метод возвращает идентификатор установленного расширения по его типу и имени-коду. Если расширение не установлено, возвращается 0
   * @param type $type
   * @param type $code
   * @return type
   */
  public function getExtensionId($type, $code)
  {
    ...
    return $query->row['extension_id'] ?? 0;
  }
