...
define('HTTP_DOCUMENTOV', $protocol . $_SERVER['HTTP_HOST'] . rtrim(rtrim(dirname($_SERVER['SCRIPT_NAME']), 'install'), '/.\\') . '/');

// DIR
define('DIR_DOCUMENTOV', str_replace('\\', '/', realpath(dirname(__FILE__) . '/../') . '/'));
